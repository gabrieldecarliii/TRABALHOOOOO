...
<head>
    ...
    <title>Finanças do Condomínio</title>

</head>
<body>

    <header>
        <h1>Finanças do Condomínio</h1>
    </header>
    ...
    <section>
        ...
        <button>
            <a href="gerarboleto.php" class="submit" vaule="Boleto">Gerar Boleto</a>
        </button>
    ...
    <script>
        ...
        function popularTabela() {
            ...
            moradores.forEach(morador => {
                ...
                statusCell.textContent = morador.pago ? 'Pago' : 'Pendente';
                statusCell.className = morador.pago ? 'pago' : 'pendente';
            });
        }
